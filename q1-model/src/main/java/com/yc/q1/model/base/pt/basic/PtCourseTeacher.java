...
public class PtCourseTeacher extends BaseEntity implements Serializable {
	...
	public PtCourseTeacher() {
		super();
	}

	public PtCourseTeacher(String id) {
		super(id);
	}
	
	public PtCourseTeacher(String classId, String teacherId, String courseId, Integer studyYear, String semester) {
		super();
		this.classId = classId;
		this.teacherId = teacherId;
		this.courseId = courseId;
