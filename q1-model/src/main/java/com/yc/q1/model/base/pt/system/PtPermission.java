...
public class PtPermission extends BaseEntity implements Serializable {
	...
	public Set<PtRole> getSysRoles() {
		return sysRoles;
	}

	public void setSysRoles(Set<PtRole> sysRoles) {
