...
public class XfCreditAccountBack extends BaseEntity implements Serializable {
	...
	@Column(name = "bagType", columnDefinition = "varchar(10) default ''", nullable = false)
	...
	@FieldInfo(name = "资金收支明细记录ID")
	@Column(name = "creditAccountId", columnDefinition = "varchar(20) default ''", nullable = true)
	...
	@FieldInfo(name = "统计分析标识")
	@Column(name = "anlysFlag", columnDefinition = "int default 0", nullable = true)
	private Integer anlysFlag;
	...
	public Integer getAnlysFlag() {
		return anlysFlag;
	}

	public void setAnlysFlag(Integer anlysFlag) {
		this.anlysFlag = anlysFlag;
	}

	public XfCreditAccountBack() {
		super();
	}

	public XfCreditAccountBack(String id) {
		super(id);
	}
}
