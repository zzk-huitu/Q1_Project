...
@Entity
@Table(name = "T_LOG_UserLogin",catalog="Q1_Storage",schema="dbo")
@AttributeOverride(name = "id", column = @Column(name = "userLoginId", length = 20, nullable = false) )
