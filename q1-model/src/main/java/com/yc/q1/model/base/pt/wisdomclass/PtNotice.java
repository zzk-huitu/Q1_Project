...
public class PtNotice extends BaseEntity implements Serializable {
	...
	private Set<PtUser> noticeUsers = new HashSet<PtUser>();
	...
	// @Cache(region = "all", usage = CacheConcurrencyStrategy.READ_WRITE)
	private Set<PtRole> noticeRoles = new HashSet<PtRole>();
	...
	// @Cache(region = "all", usage = CacheConcurrencyStrategy.READ_WRITE)
	private Set<PtDepartment> noticeDepts = new HashSet<PtDepartment>();
	...
	// @Cache(region = "all", usage = CacheConcurrencyStrategy.READ_WRITE)
	private Set<PtInfoTerminal> noticeTerms = new HashSet<PtInfoTerminal>();
	...
	@JoinTable(name = "T_PT_NoticeStudent", joinColumns = { @JoinColumn(name = "noticeId") }, inverseJoinColumns = {
			@JoinColumn(name = "userId") })
	// @Cache(region = "all", usage = CacheConcurrencyStrategy.READ_WRITE)
	private Set<PtUser> noticeStus = new HashSet<PtUser>();
	...
	private Set<PtNoticeAuditor> noticeAutitors = new HashSet<PtNoticeAuditor>();
	...
	public Set<PtUser> getNoticeUsers() {
		return noticeUsers;
	}

	public void setNoticeUsers(Set<PtUser> noticeUsers) {
		this.noticeUsers = noticeUsers;
	}

	public Set<PtRole> getNoticeRoles() {
		return noticeRoles;
	}

	public void setNoticeRoles(Set<PtRole> noticeRoles) {
		this.noticeRoles = noticeRoles;
	}

	public Set<PtDepartment> getNoticeDepts() {
		return noticeDepts;
	}

	public void setNoticeDepts(Set<PtDepartment> noticeDepts) {
		this.noticeDepts = noticeDepts;
	}

	public Set<PtInfoTerminal> getNoticeTerms() {
		return noticeTerms;
	}

	public void setNoticeTerms(Set<PtInfoTerminal> noticeTerms) {
		this.noticeTerms = noticeTerms;
	}

	public Set<PtUser> getNoticeStus() {
		return noticeStus;
	}

	public void setNoticeStus(Set<PtUser> noticeStus) {
		this.noticeStus = noticeStus;
	}

	public Set<PtNoticeAuditor> getNoticeAutitors() {
		return noticeAutitors;
	}

	public void setNoticeAutitors(Set<PtNoticeAuditor> noticeAutitors) {
