...
public class PtCalender extends BaseEntity implements Serializable {
	...
	@Column(name = "sectionCode", columnDefinition = "varchar(4) default ''", nullable = true)
