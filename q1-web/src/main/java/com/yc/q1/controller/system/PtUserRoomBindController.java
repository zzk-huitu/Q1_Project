 ...
 */
@Controller
@RequestMapping("/PtUserRoomBind")
public class PtUserRoomBindController extends FrameWorkController<PtUserRoomBind> implements Constant {

	@Resource
	PtUserRoomBindService thisService; // service层接口
	...
	public void list(PtUserRoomBind entity, HttpServletRequest request, HttpServletResponse response) throws IOException {
		String strData = ""; // 返回给js的数据
		QueryResult<PtUserRoomBind> qr = thisService.queryPageResult(super.start(request), super.limit(request),
	...
	public void doAdd(PtUserRoomBind entity, HttpServletRequest request, HttpServletResponse response)
