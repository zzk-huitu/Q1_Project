 ...
 */
@Controller
@RequestMapping("/PtUserWorkStationBind")
public class PtUserWorkStationBindController extends FrameWorkController<PtUserWorkStationBind> implements Constant {
	 ...
	 */
	@Auth("WORKSTATIONBIND_add")
	@RequestMapping("/doAdd")
	public void doAdd(PtUserWorkStationBind entity, HttpServletRequest request, HttpServletResponse response)
