...
public class BasePriceDefineController extends FrameWorkController<BaseEntity> implements Constant {
	...
	/**
	 * skList查询 @Title: list @Description: TODO
	 * 
	 * @param @param
	 *            request @param @param response @param @throws IOException
	 *            设定参数 @return void 返回类型 @throws
	 */
	@RequestMapping(value = { "/skList" }, method = { org.springframework.web.bind.annotation.RequestMethod.GET,
			org.springframework.web.bind.annotation.RequestMethod.POST })
	public void skList(HttpServletRequest request, HttpServletResponse response) throws IOException {
	...
	/**
	 * dkList查询 @Title: list @Description: TODO
	 * 
	 * @param @param
	 *            request @param @param response @param @throws IOException
	 *            设定参数 @return void 返回类型 @throws
	 */
	@RequestMapping(value = { "/dkList" }, method = { org.springframework.web.bind.annotation.RequestMethod.GET,
			org.springframework.web.bind.annotation.RequestMethod.POST })
	public void dkList(HttpServletRequest request, HttpServletResponse response) throws IOException {
		String strData = ""; // 返回给js的数据
		// 为电控时
	...
	public void doAdd(SkPriceDefine entity, DkPriceDefine entitys, HttpServletRequest request,
	...
	public void doUpdates(SkPriceDefine entity, DkPriceDefine entitys, HttpServletRequest request,
			HttpServletResponse response) throws IOException, IllegalAccessException, InvocationTargetException {
		String categroy = request.getParameter("categroy");
