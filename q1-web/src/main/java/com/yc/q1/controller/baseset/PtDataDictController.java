 ...
 */
@Controller
@RequestMapping("/PtDataDict")
public class PtDataDictController extends FrameWorkController<PtDataDict> implements Constant {

	@Resource
	private PtDataDictService thisService; // service层接口
	...
	/**
	 * 更新字典 删除redis的缓存数据，下次读取时再存入redis
	 * 
	 * @param entity
	 * @param request
	 * @param response
