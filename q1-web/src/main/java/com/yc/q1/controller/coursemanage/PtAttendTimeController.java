 ...
 */
@Controller
@RequestMapping("/PtAttendTime")
public class PtAttendTimeController extends FrameWorkController<PtAttendTime> implements Constant {

	@Resource
	PtAttendTimeService thisService; // service层接口
