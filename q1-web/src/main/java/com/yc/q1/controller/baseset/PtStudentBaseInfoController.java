...
import com.yc.q1.core.util.PinyinUtil;
 ...
 */
@Controller
@RequestMapping("/PtStudentBaseInfo")
public class PtStudentBaseInfoController extends FrameWorkController<PtStudentBaseInfo> implements Constant {
