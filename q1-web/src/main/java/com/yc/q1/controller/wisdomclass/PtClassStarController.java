...
@Controller
@RequestMapping("/PtClassStar")
public class PtClassStarController extends FrameWorkController<PtClassStar> implements Constant {
	@Resource
	PtClassStarService thisService; // service层接口
