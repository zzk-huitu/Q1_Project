...
<script id="microloader" data-app="5e27cc87-c576-447f-8977-0a13139e8872"
	type="text/javascript" src="${contextPath}/static/core/bootstrap.js"></script>
...
<body>
	...
	<link rel="stylesheet" type="text/css"
		href="${contextPath}/static/core/resources/css/icon.css" />
	<link rel="stylesheet" type="text/css"
		href="${contextPath}/static/core/resources/examples/shared/example.css" />
	...
	window.onload = function() {
		...
		var ExtCommLoad = function() {
			...
			if (!isLoad) {
				...
				comm.add("xm", "${SESSION_SYS_USER.name}");
