...
<html>
    ...
    <body style="background: url(${contextPath}/static/core/resources/images/selectSystem/index_bg.jpg)">
    	<div>
    		<div id="welecome_home"> 
    			<img class="img" src="${contextPath}/static/core/resources/images/selectSystem/组 4.png" >
    			<label class="welcome_in">欢迎进入智慧校园Q1系统</label>
    			<label class="welcome_about">关于</label>
    		</div>
    		<div id="center">
    			<div id="logo_box">
    				<img src="${contextPath}/static/core/resources/images/selectSystem/index_logo.png">
    			</div>
