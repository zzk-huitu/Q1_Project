Ext.define("core.public.allotSmartDevice.view.AllotDeviceGrid", {
    extend: "core.base.view.BaseGrid",
    alias: "widget.public.allotSmartDevice.allotDeviceGrid",
    ...
    listeners: {
        beforeitemdblclick: function(grid, record, item, index, e, eOpts) {
            ...
            var roomInfoTree = mainlayout.down("basetreegrid[xtype=public.allotSmartDevice.roomInfoTree]");
            var treelevel = roomInfoTree.getSelectionModel().getSelection()[0];
            if (treelevel == null) {
            ...
            if(mainlayout){
                isSelectGrid = mainlayout.down("panel[xtype=public.allotSmartDevice.selectedDeviceGrid]");
