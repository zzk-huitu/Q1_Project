Ext.define("core.public.selectStudent.view.SelectStudentGrid", {
    extend: "core.base.view.BaseGrid",
    alias: "widget.pubselect.selectstugrid",
    al:true,
    frame: false,
    columnLines: false,
    ...
    viewConfig: {
        ...
        listeners: {
            ...
            beforeitemdblclick: function(grid, record, item, index, e, eOpts) {
                ...
                var isSelectGrid;
                if(basePanel){
                    isSelectGrid = basePanel.down("panel[xtype=pubselect.isselectstugrid]");
