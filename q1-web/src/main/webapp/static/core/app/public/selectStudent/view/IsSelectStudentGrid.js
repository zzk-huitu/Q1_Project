Ext.define("core.public.selectStudent.view.IsSelectStudentGrid", {
    extend: "Ext.grid.Panel",
    alias: "widget.pubselect.isselectstugrid",
    ...
    viewConfig: {
        ...
        listeners: {
            ...
            beforeitemdblclick: function (grid, record, item, index, e, eOpts) {
                ...
                var selectGrid = basePanel.down("basegrid[xtype=pubselect.selectstugrid]");
