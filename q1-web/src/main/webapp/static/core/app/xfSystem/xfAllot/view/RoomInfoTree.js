Ext.define("core.xfSystem.xfAllot.view.RoomInfoTree", {
	extend: "core.base.view.BaseTreeGrid",
    alias: "widget.xfSystem.xfAllot.roomInfoTree",
    ...
    listeners: {
        itemclick: function (tree, record, item, index, e, eOpts) {
        	var mainLayout = tree.up("panel[xtype=xfSystem.xfAllot.mainLayout]");
            ...
            // 加载房间的人员信息
            var mianGrid = mainLayout.down("panel[xtype=xfSystem.xfAllot.mainGrid]");
