Ext.define("core.xfSystem.xfAllot.controller.OtherController", {
    extend: "Ext.app.ViewController",
    alias: 'controller.xfSystem.xfAllot.otherController',
    mixins: {
    ...
    /** 该视图内的组件事件注册 */
    control: {
    	 "basetreegrid[xtype=xfSystem.xfAllot.roomInfoTree2] button[ref=gridRefresh]": {
      ...
      //快速搜索按按钮
      "basegrid[xtype=xfSystem.xfAllot.deviceAllotGrid] button[ref=gridFastSearchBtn]": {
          beforeclick: function (btn) {
      ...
      //快速搜索文本框回车事件
      "basegrid[xtype=xfSystem.xfAllot.deviceAllotGrid] field[funCode=girdFastSearchText]": {
  ...
  //确认绑定事件
    saveAllot:function(btn){
        ...
        //var treegrid = allotlayout.down('basetreegrid[xtype=xfSystem.xfAllot.roominfotree2]');
        var baseGrid =allotlayout.down('panel[xtype=xfSystem.xfAllot.deviceSysGrid]');
        var deviceAllotGrid =allotlayout.down('panel[xtype=xfSystem.xfAllot.deviceAllotGrid]');
