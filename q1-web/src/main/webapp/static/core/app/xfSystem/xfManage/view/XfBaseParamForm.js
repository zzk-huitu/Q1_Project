...
Ext.define("core.xfSystem.xfManage.view.XfBaseParamForm", {
    extend: "core.base.view.BaseForm",
    alias: "widget.xfSystem.xfManage.xfBaseParamForm",
    autoScroll: true,
    items :[ {
        xtype: "fieldset",
        title: '水控基础参数',
       ...
       style: {
        ...
        items:[{
            ...
            formPanel: "xfSystem.xfManage.highparamform",   //指定当前表单的别名，方便其他地方能找到这个表单组件
