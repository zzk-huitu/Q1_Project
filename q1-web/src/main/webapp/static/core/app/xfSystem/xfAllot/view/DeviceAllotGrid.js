Ext.define("core.xfSystem.xfAllot.view.DeviceAllotGrid", {
    extend: "core.base.view.BaseGrid",
    alias: "widget.xfSystem.xfAllot.deviceAllotGrid",
    ...
    extParams: {filter: '[{"type":"string","comparison":"=","value":"0","field":"termTypeId"}]'},
    columns:  {        
        defaults:{
            titleAlign:"center"
        },
    ...
    listeners: {
        beforeitemdblclick: function(grid, record, item, index, e, eOpts) {
            ...
            var mainlayout = grid.up('panel[xtype=xfSystem.xfAllot.deviceAllotLayout]');
            var deviceSysGrid = mainlayout.down("panel[xtype=xfSystem.xfAllot.deviceSysGrid]");
            var tree = mainlayout.down("basetreegrid[xtype=xfSystem.xfAllot.roomInfoTree2]");
            ...
            var basePanel = grid.up("panel[xtype=xfSystem.xfAllot.deviceAllotLayout]");
            var isSelectGrid;
            var data = record.data;
            var selectStore = grid.getStore();
            if(basePanel){
                isSelectGrid = basePanel.down("panel[xtype=xfSystem.xfAllot.deviceSysGrid]");
