Ext.define("core.skSystem.skAllot.controller.OtherController", {
    extend: "Ext.app.ViewController",
    alias: 'controller.skSystem.skAllot.otherController',
    mixins: {
    ...
    /** 该视图内的组件事件注册 */
    control: {
    	 "basetreegrid[xtype=skSystem.skAllot.roomInfoTree2] button[ref=gridRefresh]": {
      ...
      //快速搜索按按钮
      "basegrid[xtype=skSystem.skAllot.deviceAllotGrid] button[ref=gridFastSearchBtn]": {
          beforeclick: function (btn) {
      ...
      //快速搜索文本框回车事件
      "basegrid[xtype=skSystem.skAllot.deviceAllotGrid] field[funCode=girdFastSearchText]": {
  ...
  //确认绑定事件
    saveAllot:function(btn){
        ...
        //var treegrid = allotlayout.down('basetreegrid[xtype=skSystem.skAllot.roominfotree2]');
        var baseGrid =allotlayout.down('panel[xtype=skSystem.skAllot.deviceSysGrid]');
        var deviceAllotGrid =allotlayout.down('panel[xtype=skSystem.skAllot.deviceAllotGrid]');
