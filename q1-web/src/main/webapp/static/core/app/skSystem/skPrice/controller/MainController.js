Ext.define("core.skSystem.skPrice.controller.MainController", {
    extend: "Ext.app.ViewController",
    alias: 'controller.skSystem.skPrice.mainController',
    mixins: {
    ...
    control: {
    	"basepanel basegrid[xtype=skSystem.skPrice.mainGrid]": {
    	 ...
    	 //费率列表添加按钮
    	 "basegrid[xtype=skSystem.skPrice.mainGrid] button[ref=gridAdd_Tab]": {
         ...
         //费率列表编辑按钮
         "basegrid[xtype=skSystem.skPrice.mainGrid] button[ref=gridEdit_Tab]": {
             beforeclick: function(btn) {
         ...
         //费率列表删除按钮
         "basegrid[xtype=skSystem.skPrice.mainGrid] button[ref=gridDelete]": {
             beforeclick: function(btn) {
         ...
         //费率列表绑定按钮
         "basegrid[xtype=skSystem.skPrice.mainGrid] button[ref=gridBinding]": {
             beforeclick: function(btn) {
         ...
         //快速搜索
         "basegrid[xtype=skSystem.skPrice.mainGrid] button[ref=gridFastSearchBtn]": {
               beforeclick: function(btn) {
                    var self=this;
           ...
           "basegrid[xtype=skSystem.skPrice.mainGrid] field[funCode=girdFastSearchText]": {
    ...
    doBasePriceDefine_Tab: function(btn,cmd,grid,record){
        ...
        switch (cmd) {
            case "edit":
                ...
                case "bing":
                    ...
                    var itemXtype=[{
                        xtype:"skSystem.skPrice.priceBingGrid",                        
        ...
        if(!tabItem){
            ...
            setTimeout(function(){
                ...
                if (cmd=="bing") {
                 var priceBingGrid = item.down("basegrid[xtype=skSystem.skPrice.priceBingGrid]");
    ...
    doBaseBinding:function(btn){
        ...
        var win = Ext.create('core.base.view.BaseFormWin', {
            ...
            controller:"skSystem.skPrice.otherController",
            ...
            items: [{
                detCode:detCode,
                xtype: "skSystem.skPrice.skMainLayout",
            }],
        }).show();	
     },
    ...
    disabledFuncBtn:function(grid){
        ...
        var basegrid = basePanel.down("basegrid[xtype=skSystem.skPrice.mainGrid]");
