...
*/
Ext.define("core.skSystem.skPrice.controller.OtherController", {
    extend: "Ext.app.ViewController",
    alias: 'controller.skSystem.skPrice.otherController',
    mixins: {
    ...
    /** 该视图内的组件事件注册 */
    control: {
    	   "basetreegrid[xtype=skSystem.skPrice.roomInfoTree] button[ref=gridRefresh]": {
                click: function(btn) {
    	...
    	//编辑界面保存按钮
    	"baseformtab[detCode=skPrice_detail] button[ref=formSave]": {
		...
		"baseformwin[detCode=rateBinding_detail] button[ref=formSave]": {
            ...
            //费率设备删除
        "basegrid[xtype=skSystem.skPrice.priceBingGrid] button[ref=gridDelete]": {
            beforeclick: function(btn) {
    ...
    saverate:function(btn){
        ...
        var termId = [];
        var termSn=[];
        var isselectgrid = basepanel.down('panel[xtype=skSystem.skPrice.skDataGridTwo]');
