Ext.define("core.skSystem.skPrice.view.SkDataGrid", {
	extend: "core.base.view.BaseGrid",
    alias: "widget.skSystem.skPrice.skDataGrid",
    ...
    viewConfig: {
        ...
        listeners: {
            ...
            beforeitemdblclick: function (grid, record, item, index, e, eOpts) {
                ...
                var isSelectGrid;
                if (basePanel) {
                    isSelectGrid = basePanel.down("panel[xtype=skSystem.skPrice.skDataGridTwo]");
