Ext.define("core.skSystem.skAllot.view.RoomInfoTree", {
	extend: "core.base.view.BaseTreeGrid",
    alias: "widget.skSystem.skAllot.roomInfoTree",
    ...
    listeners: {
        itemclick: function (tree, record, item, index, e, eOpts) {
        	var mainLayout = tree.up("panel[xtype=skSystem.skAllot.mainLayout]");
            ...
            // 加载房间的人员信息
            var mianGrid = mainLayout.down("panel[xtype=skSystem.skAllot.mainGrid]");
