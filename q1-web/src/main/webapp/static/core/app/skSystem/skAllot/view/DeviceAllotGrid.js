Ext.define("core.skSystem.skAllot.view.DeviceAllotGrid", {
    extend: "core.base.view.BaseGrid",
    alias: "widget.skSystem.skAllot.deviceAllotGrid",
    ...
    extParams: {filter: '[{"type":"string","comparison":"=","value":"8","field":"termTypeId"}]'},
    columns:  {        
        defaults:{
            titleAlign:"center"
        },
    ...
    listeners: {
        beforeitemdblclick: function(grid, record, item, index, e, eOpts) {
            ...
            var deviceSysGrid = mainlayout.down("panel[xtype=skSystem.skAllot.deviceSysGrid]");
            var tree = mainlayout.down("basetreegrid[xtype=skSystem.skAllot.roomInfoTree2]");
            ...
            var basePanel = grid.up("panel[xtype=skSystem.skAllot.deviceAllotLayout]");
            var isSelectGrid;
            var data = record.data;
            var selectStore = grid.getStore();
            if(basePanel){
                isSelectGrid = basePanel.down("panel[xtype=skSystem.skAllot.deviceSysGrid]");
