Ext.define("core.skSystem.skPrice.view.SkDataGridTwo", {
    extend: "Ext.grid.Panel",
    alias: "widget.skSystem.skPrice.skDataGridTwo",
    extParams: {},
    ...
    selModel: {
     ...
     store: {
        type: "skSystem.skPrice.isSelectStore"
    },
    viewConfig: {
        stripeRows: true
    },
     ...
     viewConfig: {
        ...
        listeners: {
            ...
            beforeitemdblclick: function (grid, record, item, index, e, eOpts) {
                ...
                var basePanel = grid.up("panel[xtype=skSystem.skPrice.skMainLayout]");
                var selectGrid = basePanel.down("basegrid[xtype=skSystem.skPrice.skDataGrid]");
