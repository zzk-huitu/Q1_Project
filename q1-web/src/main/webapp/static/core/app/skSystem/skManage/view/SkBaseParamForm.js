...
Ext.define("core.skSystem.skManage.view.SkBaseParamForm", {
    extend: "core.base.view.BaseForm",
    alias: "widget.skSystem.skManage.skBaseParamForm",
    autoScroll: true,
    items :[ {
        xtype: "fieldset",
        title: '水控基础参数',
       ...
       style: {
        ...
        items:[{
            ...
            formPanel: "skSystem.skManage.highparamform",   //指定当前表单的别名，方便其他地方能找到这个表单组件
