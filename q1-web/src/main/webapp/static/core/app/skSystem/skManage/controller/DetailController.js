Ext.define("core.skSystem.skManage.controller.DetailController", {
    extend: "Ext.app.ViewController",
    alias: 'controller.skSystem.skManage.detailController',
    mixins: {},
    init: function () {
        /*执行一些初始化的代码*/
    },
    /** 该视图内的组件事件注册 */
    control: {
    	'baseform[xtype=skSystem.skManage.skBaseParamForm] button[ref=checkall]':{
            click:function(btn){
                var objForm=btn.up("baseform[xtype=skSystem.skManage.skBaseParamForm]");
                for(var i=0;i<4;i++){
