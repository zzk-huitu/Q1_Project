Ext.define("core.dkSystem.dkPrice.controller.MainController", {
    extend: "Ext.app.ViewController",
    alias: 'controller.dkSystem.dkPrice.mainController',
    mixins: {
    ...
    control: {
    	"basepanel basegrid[xtype=dkSystem.dkPrice.mainGrid]": {
    	 ...
    	 //费率列表添加按钮
    	 "basegrid[xtype=dkSystem.dkPrice.mainGrid] button[ref=gridAdd_Tab]": {
         ...
         //费率列表编辑按钮
         "basegrid[xtype=dkSystem.dkPrice.mainGrid] button[ref=gridEdit_Tab]": {
             beforeclick: function(btn) {
         ...
         //费率列表删除按钮
         "basegrid[xtype=dkSystem.dkPrice.mainGrid] button[ref=gridDelete]": {
             beforeclick: function(btn) {
         ...
         //费率列表绑定按钮
         "basegrid[xtype=dkSystem.dkPrice.mainGrid] button[ref=gridBinding]": {
             beforeclick: function(btn) {
         ...
         //快速搜索
         "basegrid[xtype=dkSystem.dkPrice.mainGrid] button[ref=gridFastSearchBtn]": {
               beforeclick: function(btn) {
                    var self=this;
           ...
           "basegrid[xtype=dkSystem.dkPrice.mainGrid] field[funCode=girdFastSearchText]": {
    ...
    doBasePriceDefine_Tab: function(btn,cmd,grid,record){
        ...
        switch (cmd) {
            case "edit":
                ...
                case "bing":
                    ...
                    var itemXtype=[{
                        xtype:"dkSystem.dkPrice.priceBingGrid",                        
        ...
        if(!tabItem){
            ...
            setTimeout(function(){
                ...
                if (cmd=="bing") {
                 var priceBingGrid = item.down("basegrid[xtype=dkSystem.dkPrice.priceBingGrid]");
    ...
    doBaseBinding:function(btn){
        ...
        var win = Ext.create('core.base.view.BaseFormWin', {
            ...
            controller:"dkSystem.dkPrice.otherController",
    ...
    disabledFuncBtn:function(grid){
        ...
        var basegrid = basePanel.down("basegrid[xtype=dkSystem.dkPrice.mainGrid]");
