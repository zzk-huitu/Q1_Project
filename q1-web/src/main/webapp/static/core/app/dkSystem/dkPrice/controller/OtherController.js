...
*/
Ext.define("core.dkSystem.dkPrice.controller.OtherController", {
    extend: "Ext.app.ViewController",
    alias: 'controller.dkSystem.dkPrice.otherController',
    mixins: {
    ...
    /** 该视图内的组件事件注册 */
    control: {
    	   "basetreegrid[xtype=dkSystem.dkPrice.roomInfoTree] button[ref=gridRefresh]": {
                click: function(btn) {
		...
		"baseformwin[detCode=rateBinding_detail] button[ref=formSave]": {
            ...
            //费率设备删除
        "basegrid[xtype=dkSystem.dkPrice.priceBingGrid] button[ref=gridDelete]": {
            beforeclick: function(btn) {
