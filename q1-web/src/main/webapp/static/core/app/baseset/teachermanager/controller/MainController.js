Ext.define("core.baseset.teachermanager.controller.MainController", {
    extend: "Ext.app.ViewController",
    alias: 'controller.baseset.teachermanager.maincontroller',
    mixins: {
   ...
   control: {
            ...
            //解锁账户事件
            "basegrid[xtype=baseset.teachermanager.teachergrid] button[ref=gridUnLock]": {
                click: function(btn) {
            ...
            //重置密码事件
            "basegrid[xtype=baseset.teachermanager.teachergrid] button[ref=gridSetPwd]": {
                click: function(btn) {
            ...
            //导出
            "basegrid[xtype=baseset.teachermanager.teachergrid] button[ref=gridExport]": {
            ...
            //操作列
            "basegrid[xtype=baseset.teachermanager.teachergrid] actioncolumn": {
            ...
            "basegrid[xtype=baseset.teachermanager.teachergrid] button[ref=gridEdit_Tab]": {
                beforeclick: function (btn) {
    ...
    doList: function(btn, cmd) {
        ...
        var mainLayout = studentGrid.up("panel[xtype=baseset.teachermanager.mainlayout]");
        ...
        switch(cmd){
            case 'userRole':
                ...
                items=[{
                    ...
                    defaults:null,
                    items:[{
                        xtype:'baseset.teachermanager.teacherrolegrid',
                        title:null
                    }]
                }];
                break;
            case 'deptJob':
                ...
                items=[{
                    ...
                    defaults:null,
                    items:[{
                        xtype:'baseset.teachermanager.teacherdeptjobgrid',
                        title:null
                    }]
                }];
                break;
            case 'detail':
                ...
                items=[{
                    ...
                    defaults:null,
                    items:[{
                        xtype:'baseset.teachermanager.detailhtml',
                        title:null
                    }]
                }];
                break;
            ...
            setTimeout(function(){
                ...
                switch(cmd){
                    case 'userRole':
                        ...
                        var roleGrid = item.down("panel[xtype=baseset.teachermanager.teacherrolegrid]");
                        ...
                        break;
                    case 'deptJob':
                        var deptJobGrid = item.down("panel[xtype=baseset.teachermanager.teacherdeptjobgrid]");
                    ...
                    case 'detail':
                        ...
                        self.asyncAjax({
                            ...
                            success: function (response) {
                                ...
                                var roleUserContainer = tabItem.down("container[ref=teacherDetailInfo]");
