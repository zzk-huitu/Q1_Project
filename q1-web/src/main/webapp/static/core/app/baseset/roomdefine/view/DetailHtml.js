Ext.define("core.baseset.roomdefine.view.DetailHtml", {
    ...
    items: [{
        ...
        tpl: new Ext.XTemplate(
            ...
            '<span style="width: 10%;"><tpl if="dormCategory == 1">学生宿舍<tpl elseif="dormCategory==2">教师宿舍</tpl></span>',
            '<span style="width: 10%;" >{bedCount}</span><span style="width: 10%;">{bedCount}</span>',
            '<tpl if="isMixed==0">',
