Ext.define("core.ykt.operatorBind.view.DeptTree", {
    extend: "core.base.view.BaseTreeGrid",
    alias: "widget.ykt.operatorBind.depttree",
    ...
    tools: [{
        ...
        handler: function(event, toolEl, header) {
            ...
            var mainlayout = tree.up("basepanel[xtype=ykt.operatorBind.mainlayout]");
            var mianGrid = mainlayout.down("basegrid[xtype=ykt.operatorBind.usergrid]");
