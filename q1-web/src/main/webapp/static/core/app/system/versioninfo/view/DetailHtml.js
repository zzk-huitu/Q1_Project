        ...
        tpl: new Ext.XTemplate(
            ...
            '<div class="versionInfo" style="padding:0px;">',
                '<div class="versionInfo_left">',
                    '<span class="logo" style="background-image: url({mainLogoPhoto})"></span>',
                    '<span>{mainLogoName}</span>',
                    // '<span>参数编码：{mainLogoCode}</span>',
                '</div>',

                '<div class="versionInfo_left">',
                    '<span class="logo" style="background-image: url({smallLogoPhoto})"></span>',
                    '<span>{smallLogoName}</span>',
                    // '<span>参数编码：{smallLogoCode}</span>',
                '</div>',

                '<div class="versionInfo_left">',
                    '<span class="logo" style="background-image: url({schoolLogoPhoto})"></span>',
