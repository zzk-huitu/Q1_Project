    ...
    $.ajax({
        ...
        success: function(str) {
            if (str == "true") {
                    ...
                    $.ajax({
                        ...
                        success: function(xmlRequest) {
                            ...
                            if (returninfo == 1) {
                                ...
                                layer.alert( '用户名有误或已被禁用',{title:'提示',icon: 4,closeBtn:0});
                                ...
                                //jAlert("服务器错误", "提示");
                                layer.alert( '服务器错误',{title:'提示',icon: 2,closeBtn:0});
                                //$("#loginMsk").fadeOut();
                            }
                ...
                //jAlert("验证码错误", "提示");
                layer.alert( '验证码错误',{title:'提示',icon:7,closeBtn:0});
                $("#input2").removeAttr("disabled");
                layer.close(loadMask); 
                //alert("验证码错误。");
            }
