...
values('18041316114802000001',GETDATE(),'ROOT',0,1,1,
...
insert into T_PT_User(userId, createTime,createUser,isDelete,orderIndex,version,
	category,isSystem,state,userName,userPwd,schoolId,isHidden,
	userNumb,name,sex,rightType)
values('18041316151202000002',GETDATE(),'ROOT',0,2,1,
...
insert into T_PT_Department(deptId, createTime,createUser,isDelete,orderIndex,version,
	isLeaf,nodeCode,nodeLevel,nodeText,parentNode,deptType,isSystem,allDeptName,treeIds)
values('18041316182902000001',GETDATE(),'ROOT',0,1,1,
	'0','001',0,'演示学校','ROOT','01',1,'演示学校','18041316182902000001')

--校本部
insert into T_PT_Department(deptId, createTime,createUser,isDelete,orderIndex,version,
	isLeaf,nodeCode,nodeLevel,nodeText,parentNode,deptType,isSystem,allDeptName,treeIds)
values('18041316315002000002',GETDATE(),'ROOT',0,1,1,
	'0','002',1,'校本部','18041316182902000001','02',1,'演示学校/校本部','18041316182902000001,18041316315002000002')

--临时部门
insert into T_PT_Department(deptId, createTime,createUser,isDelete,orderIndex,version,
	isLeaf,nodeCode,nodeLevel,nodeText,parentNode,deptType,isSystem,allDeptName,treeIds)
values('18041316340402000003',GETDATE(),'ROOT',0,2,1,
	'0','003',1,'临时部门','18041316182902000001','03',1,'演示学校/临时部门','18041316182902000001,18041316340402000003')
*/
...
insert into T_PT_Job(jobId, createTime,createUser,isDelete,orderIndex,version,jobCode,jobName)
	values('18041316444502000001',GETDATE(),'ROOT',0,1,1,'01','校长');
insert into T_PT_Job(jobId, createTime,createUser,isDelete,orderIndex,version,jobCode,jobName)
	values('18041316444502000002',GETDATE(),'ROOT',0,2,1,'02','副校长');
insert into T_PT_Job(jobId, createTime,createUser,isDelete,orderIndex,version,jobCode,jobName)
	values('18041316444502000003',GETDATE(),'ROOT',0,3,1,'03','主任');
insert into T_PT_Job(jobId, createTime,createUser,isDelete,orderIndex,version,jobCode,jobName)
	values('18041316444502000004',GETDATE(),'ROOT',0,4,1,'04','副主任');
insert into T_PT_Job(jobId, createTime,createUser,isDelete,orderIndex,version,jobCode,jobName)
	values('18041316444502000005',GETDATE(),'ROOT',0,5,1,'05','团委书记');
insert into T_PT_Job(jobId, createTime,createUser,isDelete,orderIndex,version,jobCode,jobName)
	values('18041316444502000006',GETDATE(),'ROOT',0,6,1,'06','主管');
insert into T_PT_Job(jobId, createTime,createUser,isDelete,orderIndex,version,jobCode,jobName)
	values('18041316444502000007',GETDATE(),'ROOT',0,7,1,'07','学科组长');
insert into T_PT_Job(jobId, createTime,createUser,isDelete,orderIndex,version,jobCode,jobName)
	values('18041316444502000008',GETDATE(),'ROOT',0,8,1,'08','年级组长');
insert into T_PT_Job(jobId, createTime,createUser,isDelete,orderIndex,version,jobCode,jobName)
	values('18041316444502000009',GETDATE(),'ROOT',0,9,1,'09','备课组长');
insert into T_PT_Job(jobId, createTime,createUser,isDelete,orderIndex,version,jobCode,jobName)
	values('18041316444502000010',GETDATE(),'ROOT',0,10,1,'10','班主任');
insert into T_PT_Job(jobId, createTime,createUser,isDelete,orderIndex,version,jobCode,jobName)
	values('18041316444502000011',GETDATE(),'ROOT',0,11,1,'11','实验员');
insert into T_PT_Job(jobId, createTime,createUser,isDelete,orderIndex,version,jobCode,jobName)
	values('18041316444502000012',GETDATE(),'ROOT',0,12,1,'12','教师');
insert into T_PT_Job(jobId, createTime,createUser,isDelete,orderIndex,version,jobCode,jobName)
	values('18041316444502000013',GETDATE(),'ROOT',0,13,1,'13','办事员');
insert into T_PT_Job(jobId, createTime,createUser,isDelete,orderIndex,version,jobCode,jobName)
	values('18041316444502000014',GETDATE(),'ROOT',0,14,1,'14','学生');
insert into T_PT_Job(jobId, createTime,createUser,isDelete,orderIndex,version,jobCode,jobName)
	values('18041316444502000015',GETDATE(),'ROOT',0,15,1,'15','场馆负责人');
insert into T_PT_Job(jobId, createTime,createUser,isDelete,orderIndex,version,jobCode,jobName)
	values('18041316444502000016',GETDATE(),'ROOT',0,16,1,'16','测试人员');
*/
...
insert into T_PT_Role(roleId, createTime,createUser,isDelete,orderIndex,version,
	...
	values('18041316595402000001',GETDATE(),'ROOT',0,1,1,1,1,'SUPERADMIN','超级管理员');
insert into T_PT_Role(roleId, createTime,createUser,isDelete,orderIndex,version,
	isHidden,isSystem,roleCode,roleName)
	values('18041316595402000002',GETDATE(),'ROOT',0,2,1,0,1,'SCHOOLADMIN','学校管理员');
insert into T_PT_Role(roleId, createTime,createUser,isDelete,orderIndex,version,
	isHidden,isSystem,roleCode,roleName)
	values('18041316595402000003',GETDATE(),'ROOT',0,3,1,0,1,'PRESIDENT','校长');
insert into T_PT_Role(roleId, createTime,createUser,isDelete,orderIndex,version,
	isHidden,isSystem,roleCode,roleName)
	values('18041316595402000004',GETDATE(),'ROOT',0,4,1,0,1,'VICEPRESIDENT','副校长');
insert into T_PT_Role(roleId, createTime,createUser,isDelete,orderIndex,version,
	isHidden,isSystem,roleCode,roleName)
	values('18041316595402000005',GETDATE(),'ROOT',0,5,1,0,1,'DIRECTOR','主任');
insert into T_PT_Role(roleId, createTime,createUser,isDelete,orderIndex,version,
	isHidden,isSystem,roleCode,roleName)
	values('18041316595402000006',GETDATE(),'ROOT',0,6,1,0,1,'VICEDIRECTOR','副主任');
insert into T_PT_Role(roleId, createTime,createUser,isDelete,orderIndex,version,
	isHidden,isSystem,roleCode,roleName)
	values('18041316595402000007',GETDATE(),'ROOT',0,7,1,0,1,'GRADELEADER','年级组长');
insert into T_PT_Role(roleId, createTime,createUser,isDelete,orderIndex,version,
	isHidden,isSystem,roleCode,roleName)
	values('18041316595402000008',GETDATE(),'ROOT',0,8,1,0,1,'CLASSLEADER','班主任');
insert into T_PT_Role(roleId, createTime,createUser,isDelete,orderIndex,version,
	isHidden,isSystem,roleCode,roleName)
	values('18041316595402000009',GETDATE(),'ROOT',0,9,1,0,1,'TEACHER','教师');
insert into T_PT_Role(roleId, createTime,createUser,isDelete,orderIndex,version,
	isHidden,isSystem,roleCode,roleName)
	values('18041316595402000010',GETDATE(),'ROOT',0,10,1,0,1,'STUDENT','学生');
insert into T_PT_Role(roleId, createTime,createUser,isDelete,orderIndex,version,
	isHidden,isSystem,roleCode,roleName)
	values('18041316595402000011',GETDATE(),'ROOT',0,11,1,0,1,'TEST','测试');
*/
...
insert into T_PT_RoleUser values('18041316114802000001','18041316595402000001')
insert into T_PT_RoleUser values('18041316151202000002','18041316595402000002')
*/
...
insert into T_PT_School(schoolId, createTime,createUser,isDelete,orderIndex,version,schoolCode,schoolName)
	values('18041316182902000001',GETDATE(),'ROOT',0,1,1,'ZHXY','演示学校');
*/
...
insert into T_PT_Campus(campusId, createTime,createUser,isDelete,orderIndex,version,schoolId,campusName)
	values('18041316315002000002',GETDATE(),'ROOT',0,1,1,'18041316182902000001','校本部');
*/
...
insert into T_PT_RoomArea(areaId, createTime,createUser,isDelete,orderIndex,version,
	...
	values('18041316182902000001',GETDATE(),'ROOT',0,1,1,0,'',1,'演示学校','ROOT','18041316182902000001','01');

insert into T_PT_RoomArea(areaId, createTime,createUser,isDelete,orderIndex,version,
	isLeaf,nodeCode,nodeLevel,nodeText,parentNode,treeIds,areaType)
	values('18041316315002000002',GETDATE(),'ROOT',0,2,1,1,'',2,'校本部','18041316182902000001','18041316182902000001,18041316315002000002','02');
*/
...
begin
	...
	select @id2=[dbo].[F_PT_GetKeyId]('02') ;
