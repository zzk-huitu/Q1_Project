...
@Service
@Transactional
public class PtAttendThemeServiceImpl extends BaseServiceImpl<PtAttendTheme> implements PtAttendThemeService{
	...
	private static Logger logger = Logger.getLogger(PtAttendThemeServiceImpl.class);
