...
@Service
@Transactional
public class PtDeptJobServiceImpl extends BaseServiceImpl<PtDeptJob> implements PtDeptJobService {

	@Resource(name = "PtDeptJobDao") // 将具体的dao注入进来
	...
	@Resource
	private PtDepartmentService deptService;

	@Resource
	private PtJobService jobService;

	@Resource
	private PtUserDeptJobService baseUserdeptjobService;

	@Resource
	private PtUserService userService;

	private static Logger logger = Logger.getLogger(PtDeptJobServiceImpl.class);
