...
@Service
//@Transactional
public class PtAccountServiceImpl extends BaseServiceImpl<PtAccount> implements PtAccountService{

	@Resource(name = "PtAccountDao") // 将具体的dao注入进来
	public void setDao(BaseDao<PtAccount> dao) {
		super.setDao(dao);
	}
	@Resource
