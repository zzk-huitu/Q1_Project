...
/**
 * 
 * ClassName: EccClassregflagService
 * Function: TODO ADD FUNCTION. 
 * Reason: TODO ADD REASON(可选). 
 * Description: 班级流动红旗(ECC_T_CLASSREGFLAG)实体Service接口类.
 * date: 2016-12-13
 *
 * @author  luoyibo 创建文件
 * @version 0.1
...
public interface PtClassRedFlagService extends BaseService<PtClassRedFlag> {
