...
/**
 * 
 * ClassName: OaNoticeauditorService
 * Function: TODO ADD FUNCTION. 
 * Reason: TODO ADD REASON(可选). 
 * Description: 公告审核人(OA_T_NOTICEAUDITOR)实体Service接口类.
 * date: 2016-12-21
 *
 * @author  luoyibo 创建文件
 * @version 0.1
...
public interface PtNoticeAuditorService extends BaseService<PtNoticeAuditor> {
