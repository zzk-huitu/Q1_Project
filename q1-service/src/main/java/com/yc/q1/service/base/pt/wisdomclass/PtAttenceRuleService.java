...
/**
 * 
 * ClassName: JwCheckruleService
 * Function: TODO ADD FUNCTION. 
 * Reason: TODO ADD REASON(可选). 
 * Description: 课程考勤规则(JW_T_CHECKRULE)实体Service接口类.
 * date: 2017-05-10
 *
 * @author  luoyibo 创建文件
 * @version 0.1
...
public interface PtAttenceRuleService extends BaseService<PtAttenceRule> {
	...
	/**
	 * 启用或停用指定的考勤规则
	 * @param ids 启用或停用的规则的标识
	 * @param usingStatu 启用或停用状态
	 * @return
	 */
