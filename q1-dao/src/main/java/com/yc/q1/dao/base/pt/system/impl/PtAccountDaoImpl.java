...
import com.yc.q1.dao.base.pt.system.PtAccountDao;
 ...
 * @since JDK 1.8
 */
@Repository("PtAccountDao")
public class PtAccountDaoImpl extends BaseDaoImpl<PtAccount> implements PtAccountDao {
}