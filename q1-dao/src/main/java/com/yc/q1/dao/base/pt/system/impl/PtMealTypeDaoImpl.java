...
import com.yc.q1.dao.base.pt.system.PtMealTypeDao;
 ...
 * @since JDK 1.8
 */
@Repository("PtMealTypeDao")
public class PtMealTypeDaoImpl extends BaseDaoImpl<PtMealType> implements PtMealTypeDao {
}