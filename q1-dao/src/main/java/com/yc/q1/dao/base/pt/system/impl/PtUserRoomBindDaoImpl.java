...
import com.yc.q1.dao.base.pt.system.PtUserRoomBindDao;
 ...
 * @since JDK 1.8
 */
@Repository("PtUserRoomBindDao")
public class PtUserRoomBindDaoImpl extends BaseDaoImpl<PtUserRoomBind> implements PtUserRoomBindDao {
}