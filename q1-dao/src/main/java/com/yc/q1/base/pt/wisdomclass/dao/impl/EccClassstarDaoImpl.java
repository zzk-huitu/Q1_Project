...
import com.yc.q1.base.pt.wisdomclass.dao.EccClassstarDao;
 ...
 */
@Repository
public class EccClassstarDaoImpl extends BaseDaoImpl<ClassStar> implements EccClassstarDao {
    public EccClassstarDaoImpl() {
        super(ClassStar.class);
