...
import com.yc.q1.base.pt.wisdomclass.dao.AttTitleDao;
 ...
 */
@Repository
public class AttTitleDaoImpl extends BaseDaoImpl<AttendTheme> implements AttTitleDao {
    public AttTitleDaoImpl() {
        super(AttendTheme.class);
