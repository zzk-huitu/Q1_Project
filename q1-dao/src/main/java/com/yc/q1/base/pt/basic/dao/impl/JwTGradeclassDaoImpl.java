...
import com.yc.q1.base.pt.basic.dao.JwTGradeclassDao;
 ...
 */
@Repository
public class JwTGradeclassDaoImpl extends BaseDaoImpl<GradeClass> implements JwTGradeclassDao {
    public JwTGradeclassDaoImpl() {
        super(GradeClass.class);
